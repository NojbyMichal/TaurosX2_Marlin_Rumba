...
// position of drivers for X2
// on board:    X   Y  Z  E0  E1  E2
// physically:  X0  Y  Z  E0  E1  X1
...
#else  // DUAL_X_DRIVE  
#  define X0_STEP_PIN      17
#  define X0_DIR_PIN       16
#  define X0_ENABLE_PIN    48
// These secondary X drive pins are for RepRap X2v3 extension board
#  define X1_STEP_PIN      29
#  define X1_DIR_PIN       28
#  define X1_ENABLE_PIN    39
#endif // DUAL_X_DRIVE
