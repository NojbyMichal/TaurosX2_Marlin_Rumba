...
#define EXTRUDE_MINTEMP 175 // in deg
...
#define X0_MAX_POS 300
#define X1_MAX_POS 236
//#define X_MIN_POS 0
#define X0_MIN_POS -95
#define X1_MIN_POS -30
...
// default settings 
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {129.1140845,128.7140703,800,231.32945,209.7818} // X,Y,Z,E0... SAE Prusa w/ Wade extruder
#define DEFAULT_AXIS_STEPS_PER_UNIT   {129.1140845,128.7140703,800,214.1939,209.7818} // X,Y,Z,E0... SAE Prusa w/ Wade extruder
#define DEFAULT_MAX_FEEDRATE          {500, 500, 5, 25, 25} // X,Y,Z,E0...(mm/sec)    
#define DEFAULT_MAX_ACCELERATION      {3000, 3000, 50, 10000, 10000}// X,Y,Z,E0... maximum acceleration (mm/s^2). E default values are good for skeinforge 40+, for older versions raise them a lot.
#define DEFAULT_RETRACT_ACCELERATION  {1500, 1500} // E0... (per extruder) acceleration in mm/s^2 for retracts 
#define DEFAULT_ACCELERATION          1500    // X,Y,Z and E* acceleration (one for all) in mm/s^2 for printing moves 
